...
dce_result_t dce_handle_GMI(dce_t* dce, void* group_ctx, int kind, int argc, arg_t* argv)
{
    dce_emit_basic_result_code(dce, DCE_RC_ERROR);
    return DCE_OK;
}

dce_result_t dce_handle_GMM(dce_t* dce, void* group_ctx, int kind, int argc, arg_t* argv)
{
    dce_emit_basic_result_code(dce, DCE_RC_ERROR);
    return DCE_OK;
}

dce_result_t dce_handle_GMR(dce_t* dce, void* group_ctx, int kind, int argc, arg_t* argv)
{
    dce_emit_basic_result_code(dce, DCE_RC_ERROR);
    return DCE_OK;
}

dce_result_t dce_handle_GSN(dce_t* dce, void* group_ctx, int kind, int argc, arg_t* argv)
{
    dce_emit_basic_result_code(dce, DCE_RC_ERROR);
    return DCE_OK;
}
